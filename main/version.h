...
#define FIRMWARE_VERSION "1.19.37"
...
#define FIRMWARE_RELEASE_NOTES "Cinque miglioramenti UX: conferma prima di riavviare, badge \"modifiche non salvate\" sui tab, test di connessione NTRIP dal form, note di rilascio qui, copia rapida IP/indirizzo in Stato."
