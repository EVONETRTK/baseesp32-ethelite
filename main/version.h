...
#define FIRMWARE_VERSION "1.19.39"
...
#define FIRMWARE_RELEASE_NOTES "Fix: la ricerca tra le impostazioni non mostrava mai i risultati (bug di CSS/display introdotto in 1.19.38)."
