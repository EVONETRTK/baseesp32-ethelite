...
#define FIRMWARE_VERSION "1.19.45"
...
#define FIRMWARE_RELEASE_NOTES "Fix critico: stack overflow reale nel task main causato da eth_link_init() (probabilmente presente e nascosto dal riavvio automatico fin dalla 1.19.40) - spostata in un task dedicato."
