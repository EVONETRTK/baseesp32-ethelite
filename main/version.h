...
#define FIRMWARE_VERSION "1.19.40"
...
#define FIRMWARE_RELEASE_NOTES "Ethernet (W5500 via SPI) attivata e corretta per davvero: mancava un include e l'opzione Kconfig del componente esp_eth, mai verificate su hardware reale finora."
