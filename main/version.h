...
#define FIRMWARE_VERSION "1.19.43"
...
#define FIRMWARE_RELEASE_NOTES "Cinque novita': checkbox RTCM disattivate se non supportate dal chip, pulsante annulla modifiche, stato Ethernet in Stato, validazione formato host NTRIP, byte RTCM per messaggio in Segnali."
